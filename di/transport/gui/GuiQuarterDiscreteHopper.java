...
public class GuiQuarterDiscreteHopper extends GuiContainer
{
	
	private ResourceLocation texture = new ResourceLocation("discreteindustry","textures/gui/QuarterDiscreteHopper.png");
	
	public GuiQuarterDiscreteHopper(InventoryPlayer invp_, TileEntityDiscreteHopper tile_)
	{
